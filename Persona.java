public class Persona{
    ...
    public void inputNome(){
        setNome(Main.strput("inserisci il nome"));
    }
    ...
    public void inputCognome(){
        setCognome(Main.strput("inserisci il cognome"));
    }
    ...
    public void inputAnni(){
        setAnni(Main.input("inserisci gli anni di "+getNome()+" "+getCognome()));
    }
    ...
    public void inputCodiceFiscale(){
        setCodiceFiscale(Main.strput("inserisci il codice fiscale di "+getNome()+" "+getCognome()));
    }
    
    public void outPersona(){
        Main.output(nome+" "+cognome+":\n\tanni:\t"+anni+"\n\tcodice fiscale:\t"+codiceFiscale);
    }
}